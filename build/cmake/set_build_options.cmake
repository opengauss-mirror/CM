...
if (ENABLE_XALARMD)
    ...
    if (ENABLE_XALARM_REPORT_EVENT_LEN)
        message("ENABLE_XALARM_REPORT_EVENT_LEN is on: xalarm_report_event 3-arg ABI (CM_XALARM_REPORT_EVENT_HAS_LEN).")
        add_definitions(-D CM_XALARM_REPORT_EVENT_HAS_LEN)
    else ()
        message("ENABLE_XALARM_REPORT_EVENT_LEN is off: xalarm_report_event 2-arg ABI (legacy); unregister uses single-pointer ABI.")
        add_definitions(-D CM_XALARM_LEGACY_REGISTER_ABI)
    endif ()
endif()
