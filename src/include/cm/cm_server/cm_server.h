...
#define CM_MAX_RES_SLOT_COUNT 8
...
typedef enum { NOT_NEED_TO_NOTITY_CN = 0, WAIT_TO_NOTFY_CN, NEED_TO_NOTITY_CN } NotifyCn_t;
...
typedef struct ThreadExecStatus {
    uint32 count;
